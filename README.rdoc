...
16. ensure status and comment fields are updated correctly and their value is show correctly in the view. -- Done in #edit/#update

17. BUG? Why paradigm_type_id is used in the forms if it should be rather paradigm_id?

...
1. INPROGRESS: a new model Inflector serves to convert given word with the given tag to the given tags
	...
	* how to configure the external script to be used? maybe as a server
	* any encoding issues: web app expects UTF8 meanwhile prosao1 returns CP1252? test with FSE
	* fix letter case of words returned from prosao1 syn_ldb if necessary
...
2. INPROGRESS: implement converting words in paradigm#edit
	...
	* INPROGRESS: use ajax to serve conversion procedure.

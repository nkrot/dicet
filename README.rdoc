...
3. In paradigms#new, allow editing/deleting individual paradigms.
   * see bug#6 (deleting an unsaved paradigm)

4. In paradigms#edit, do not save duplicate word+tag pairs in the same paradigm.

5. How to create more that one paradigm with the same noun (Band: Bänder/Bande)? -- this stopped (?) working when pdg creation buttons were reimplemented using ajax

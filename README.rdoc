...
5. INPROGRESS: Add possibility to search sentences from the paradigm new/edit pages.
  ...
  * add JQuery. handle spaces
  * add another button for case-sensitive search? (Ss) for case insensitive and (S) for case-sensitive
  * how to make that the browser does now switch to the new page immediatelly? instead, stay on the page and add counts how many stuff was found

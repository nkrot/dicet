...
16. DONE: on the user's page show unfinished tasks and not-started tasks separately
   ...
   * INPROGRESS: if the list of the non-started tasks is empty, do not show the empty table. Show the link to All tasks page instead
...
2. Load sentences. Keep the text titles when possible.
  * INPROGRESS: uploading sentences via sentences#upload. How to set document_id?
  ...
  * Loading taks very long time.. Investigate how direct table loading works? see http://stackoverflow.com/questions/697004/bulk-load-data-into-sqlite and http://infolab.stanford.edu/~widom/cs145/sqlite/SQLiteLoad.html

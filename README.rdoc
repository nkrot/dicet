...
2. INPROGRESS: Allow adding tags in bulk via console API and seeds
	...
	* TODO: add a description to help page

3. Allow editing tags via web interface?

4. Allow adding new paradigm types via web interface
	* add validations of tag correctness: via ajax or on the client side?

5. Allow adding new paradigm types via console api and seeds

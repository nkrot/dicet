...
7. INPROGRESS: Implement navigation through the task words of the current task in a side pane
  * DONE: show the current task content
  * styling. highlight the current word

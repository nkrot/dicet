...
1. INPROGRESS: a new model Inflector serves to convert given word with the given tag to the given tags
...
2. INPROGRESS: implement converting words in paradigm#edit
	...
	* DONE: double clicking on (<) button should trigger conversion procedure. TODO: double click does not prevent two single clicks from happening. it does not harm however
...
7. Ensure that all changed word forms (including those that were before CONVERT was pressed) are highlighted as changed

...
6. INPROGRESS: assign task statuses, more particularly, READY, and hide READY tasks by default. display user tasks in three categories (and with count stats):
   ...
   * not started tasks (status new).

7. allow sort tasks by modification time (allows finding most recently done tasks or tasks in progress)

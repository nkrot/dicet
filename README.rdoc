...
7. INPROGRESS: Show completed tasks (having status 'ready')
   * DONE: on an additional page, most recently completed tasks first. add a link to the user's page to the additional page, the path should be: /users/1/tasks/ready
   * DONE: completed by all users. The path is /tasks/ready 
   * DONE: add total counts of completed tasks
   * DONE: add counts of tasks completed today, since one week ago and since one month ago
   * DONE: When showing tasks by all users, include the doer in the table.
   * DONE: Get rid of Drop button in the table
   * DONE: Include time in the table
...
10. NEXT: Showing most recently modified tasks
   * ??? show the most recently modified task on the user page?

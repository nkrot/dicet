...
10. BUG: on the user's page, after dropping a current task, the page is redisplayed without unfinished tasks.
...
13. move tasks_controller#update_user_tasks into the model
	* write tests
...
15. refactor so as to get rid of duplication in users_controller#show and tasks_controller#drop
...
17. Refactor: this user's page should be http://localhost:3000/users/1/tasks instead of http://localhost:3000/users/1

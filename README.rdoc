...
== TODO for tagset and paradigm types
...
2. DONE: Allow adding tags in bulk via console API and seeds
	...
	* rake db:seed -- calls TagsController#add_file_data and works slowly!
...
6. INPROGRESS: move xxx_controller.add_file_data to corresponding models!
   * tags_controller.rb
   * words_controller.rb
   * DONE: paradigm_types_controller.rb

7. in Model#add_file_data access errors in object.errors.full_messages and display them in the generated report.
...
3. INPROGRESS: allow marking a word as a typo and allow adding the correct variant
    * DONE: what about having it as a paradigm of type Typo that opens with two positions
	* DONE: output it in the dump

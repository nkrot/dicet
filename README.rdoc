...
1. DONE: Users should be able of dropping the tasks. Dropped tasks are returned to the common task pull.

Dropping the task via ajax:
 experiment with link_to and button_to
 once a task has been dropped:
    show feedback on this fact
	hide the task from the users task list w/o reloading the page 

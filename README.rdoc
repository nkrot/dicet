...
3. INRPOGRESS: Add a separate page for searching sentences by word(s). a-la corpus search
  * DONE: case-insensitive search
  * DONE: highlight requested word in the text.
  * DONE: escape html special entities
  * allow randomized display of retrieved sentences
  * DONE: dont output duplicates (search 'computer')
  * simplify the form elements in order to make the link easier to read: ?word=blah-blah-blah

4. Add possibility to search examples to the paradigm new/edit page.
  * all words from the paradigm at once? add a button for this
  * individual word -- add a button for this

5. How to display the results found should be displayed when the search is triggered on the paradigm new/edit page?
  * in a frame?
  * in a new page

6. make everything utf-8: http://craiccomputing.blogspot.com/2011/02/rails-utf-8-and-heroku.html
	* fix all uploaders to assume utf-8

7. add counts of search results

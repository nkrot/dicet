...
12. paradigms#edit edits only one (selected) paradigm. 
   ...
   * styling: the form that was changed shoould be highlighted to show a change was made. same, the save button should be highlighted to show the paradigm needs to be saved.

13. DONE: pass word_id to paradigms#edit, so that click_to_copy works

14. INPROGRESS: Deleting the whole paradigm

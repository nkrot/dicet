...
8. BUG: on #new, when multiple paradigms are shown and DELETE is pressed, all paradigms are greyed out. Only the corrent one should be greyed. However, the deletion works correctly: only one paradigm is deleted.

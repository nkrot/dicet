...
1. INPROGRESS: Schema for storing sentences will include:
  * DONE: tokens: id, text, upcased_text;;; add index on text and upcased_text
  * DONE: document: id, title
  * DONE: sentences: id, document_id (has_many tokens through sentence_tokens)
